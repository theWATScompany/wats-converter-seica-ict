...
Converts Seica in-circuit test XML result files to WATS UUT reports.
...
Seica manufactures in-circuit test (ICT) and flying probe systems. This converter imports Seica ICT XML test results into WATS.
...
The recommended installation method is via the installer. Download the latest release from the [Releases](https://github.com/Virinco/WATS-Converter-Seica-ICT/releases/latest) page.

## Installation

### Using the Installer (Recommended)
1. Download the installer (`.exe`) from the [Releases](https://github.com/Virinco/WATS-Converter-Seica-ICT/releases/latest) page.
...
1. Download the `.dll` file from the [Releases](https://github.com/Virinco/WATS-Converter-Seica-ICT/releases/latest) page.
...
## Resources
- [GitHub Repository](https://github.com/Virinco/WATS-Converter-Seica-ICT)
- [Seica](https://www.seica.com)
